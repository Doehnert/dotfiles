...
vim.o.foldexpr = [[
  luaeval("require'nvim-treesitter'.foldexpr()") ~= 0
  and luaeval("require'nvim-treesitter'.foldexpr()")
  or v:lua.vim.lsp.buf.foldexpr()
]]
vim.o.foldcolumn = '1' -- Shows a column with fold indicators (e.g., "1", "2", etc.)
vim.o.foldlevel = 0
